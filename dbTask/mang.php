...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="mang.php">Mangers <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <header class="w-100 100-vh">
       ...
       <div class="overlay">
          ...
          <h1 class="adr bg-danger text-center">Employees</h1>
       </div>
...
$queryString = "SELECT emp.firstName , mang.firstName FROM employees AS emp JOIN employees AS mang on mang.reportsTo =emp.employeeNumber";
