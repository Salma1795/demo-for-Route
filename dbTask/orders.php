...
<body>
    ...
    <header class="w-100 100-vh">
       ...
       <div class="overlay">
          ...
          <h1 class="adr bg-danger text-center">Orders</h1>
       </div>
...
$queryString = "SELECT customers.customerName, orderdetails.quantityOrdered FROM customers, orderdetails";
...
//      echo $row['customerName']." ". $row['quantityOrdered'];
//     echo "<br/>";
// }
