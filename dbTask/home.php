...
<body>
    ...
    <header class="w-100 100-vh">
       ...
       <div class="overlay">
          ...
          <h1 class="adr bg-danger text-center">All Customers with Credit Limit Greater Than 20000</h1>
...
$queryString = "SELECT customerName, creditLimit FROM customers WHERE creditLimit > 20000";
...
<a class="mt-5" href="logout.php">LOG OUT</a>