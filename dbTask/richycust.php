...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="richCustomers.php">Rich Customers <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <header class="w-100 100-vh">
       <div class="overlay">
          ...
          <h1 class="adr bg-danger text-center">The most rich customers</h1>
       </div>
    </header>
...
$queryString = "SELECT customerName, creditLimit FROM customers WHERE city = '$city'
